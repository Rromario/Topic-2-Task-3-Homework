...
Окошко с текстом будет выглядеть примерно вот так (если у вас тёмная тема оформления браузера): ![](D:/Обучение/Git Work Project/Тема 2 Задача 3/Версия с README/Topic-2-Task-3-Homework/alert.png)
