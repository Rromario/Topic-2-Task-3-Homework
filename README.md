...
## Задача
1.	Клонируйте Git-репозиторий по [ссылке](https://github.com/netology-code/git-homeworks-neuro-broken.git); 
#### Команда 1
git clone https://github.com/netology-code/git-homeworks-neuro-broken.git
...
#### Команда 3:
git checkout main
Используя команды переключения между коммитами, определите в каком коммите и кем была внесена ошибка. После переключения между коммитами обновляйте открытый в браузере файл index.html.
#### Команда 4:
git log b557916
#### ОТвет:
...
Окошко с текстом будет выглядеть примерно вот так (если у вас тёмная тема оформления браузера): [![](](https://github.com/Rromario/Topic-2-Task-3-Homework/blob/1db99b778ea16341a6f2d1c906b560d33d3ca1ec/alert.png)
